...
def build_analytical_report() -> str:
    ...
    history = pd.read_csv(TABLES / "historical_change_1991_2011.csv").set_index("indicatore")
...
![Profilo 2024](figures/01_snapshot_bagheria_2024.png)
...
![Storia e posizione relativa](figures/02_storia_livelli_e_posizione.png)
...
![Benchmark della transizione 2011](figures/03_transizione_benchmark_2011.png)
...
![Composizione 2018-2024](figures/04_composizione_giovani_2018_2024.png)

![Confronto degli stati 2024](figures/05_benchmark_stati_2024.png)
...
![Gap con la Sicilia](figures/06_gap_con_sicilia_2018_2024.png)
...
![Scomposizione del cambiamento](figures/07_scomposizione_cambiamento_2018_2024.png)
...
![Traiettoria 25-49](figures/08_traiettoria_25_49.png)

![Posizionamento 25-49](figures/09_posizionamento_istruzione_lavoro_25_49.png)
...
![Popolazione 15-34](figures/10_popolazione_15_34.png)
...
![Confronto con i peer](figures/11_confronto_peer_2011.png)
