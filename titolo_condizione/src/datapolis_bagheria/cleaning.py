...
def build_clean_data() -> dict[str, object]:
    ...
    outputs = {
        ...
        "indicator_dictionary.csv": indicators,
        "census_education_work_long.csv": current,
        "census_population_long.csv": population,
        "census_commuting_long.csv": commuting,
        "technical_schools.csv": schools,
        "palermo_gtfs_summary.csv": gtfs_summary,
        "palermo_central_station_stops.csv": central_stops,
    }
    ...
    (PROCESSED / "quality_report.json").write_text(json.dumps(quality, indent=2, ensure_ascii=False), encoding="utf-8")
    return quality
