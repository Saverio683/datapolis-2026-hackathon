...
- `docs/edu/README.md`: deliverable con path inesistenti (`outputs/…`, `make process`). Se rigenerato da pipeline.edu correggere il template, non il file; o escluderlo dal pacchetto.
