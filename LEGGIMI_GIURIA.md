...
le visualizzazioni e la policy proposal) e la presentazione proiettata al festival il
24 settembre. Percorso di lettura consigliato, dal risultato al metodo:

1. **`dist/PRESENTAZIONE_PONTE_19.pdf`** - la presentazione del progetto al festival
   DataPolis, 24 settembre 2026: 19 slide, la sintesi più rapida di diagnosi e proposta.
   È il deck proiettato, con quattro slide (12, 16, 17 e 18) corrette la sera stessa per
   allinearle alla revisione di relazione e policy: le casalinghe come stima di modello e
   non come dichiarazione, la finestra B a 22-25 anni con i 21enni presi in carico su
   segnalazione, le componenti di chi cerca lavoro e degli inattivi lette sul 2021-2024, il
...
4. **Le data viz richieste (2-3)** - le tre figure principali sono
...
5. **Le schede** - quattro schede tematiche, una per richiesta del bando (profilo e
...
6. **`notebooks/`** - il technical notebook: `analisi.ipynb` (definizioni condivise) e i
...
7. **Riproduzione da ambiente pulito** - i comandi, nell'ordine, sono in `README.md`.
