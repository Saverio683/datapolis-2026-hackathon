...
`docs/team/SCELTE_ANALITICHE.md` (terna delle figure, mappa brief, limite 3, checklist). Il terzo focus
del bando — «Dinamiche e ruolo del pendolarismo verso Palermo» — è misurabile e misurato.
Resta da rigenerare `docs/relazione/RELAZIONE_DATAPOLIS.docx`, fermo alla versione precedente.
...
La proposta unificata (`docs/policy/POLICY_PONTE_19.md`) regge e **si rafforza**: la sua finestra B
