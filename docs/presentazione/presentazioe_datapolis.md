...
| **13,4%** | Casalinghe dichiarate fra le 15-24enni nel 2024, contro 11,3% a Palermo, 10,1% in Sicilia e 4,6% in Italia | _«Condizione dichiarata o ore di cura misurate?»_ | «Carico di cura», «responsabilità familiari» |
...
3. **13,4%** contro **4,6%** in Italia (11,3 Palermo, 10,1 Sicilia): casalinghe dichiarate, sono le barre della fig02b.
...
5. **+1,4 punti**: il KPI primario, tasso di occupazione F 15-24 da 8,2 al 9,6 di Palermo, letto su un triennio.
...
- **Come si misura.** KPI in tasso, non in teste. Primario: occupazione F 15-24 da 8,2% a 9,6% (il valore di Palermo), +1,4 punti, leggibile solo su un triennio perché il delta annuale rilevabile è 2,14 punti. Secondario: casalinghe dichiarate da 13,4% a 11,3%. Esito del servizio sui presi in carico: occupati, in istruzione o in formazione a sei mesi, con esito ancora attivo al dodicesimo.
- **Come si sa se ha funzionato.** Rollout scaglionato con lista d'attesa: a parità di priorità l'ordine di avvio è casuale, chi inizia dopo è il confronto. Protocollo, outcome e finestre pubblicati prima dell'avvio. Per un contest data-driven è l'asset più forte che abbiamo: **il pilota produce la propria evidenza**. Va detto come titolo della sezione, non come risposta di riserva alla domanda sul p-value.
- **Tempi.** Decision gate a 90 giorni di preparazione, 12 mesi di erogazione, follow-up a 3, 6 e 12 mesi.
...
I documenti sono consegnati dal 30 agosto e la presentazione è il 24 settembre: l'armonizzazione non può più avvenire. `pipeline.verifica` passa (755 su 755) perché queste cifre stanno fuori dalla sua copertura, quindi le discrepanze sono nei PDF che la commissione ha in mano. Non si pronunciano spontaneamente. Se un giurato le solleva, la risposta è il valore giusto con la fonte, in una frase, senza bloccarsi.
