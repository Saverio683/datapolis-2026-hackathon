...
`docs/relazione/RELAZIONE_DATAPOLIS.md` (la relazione completa, scritta il 2026-08-28: i due
paragrafi vi compaiono verbatim nella sezione «In una pagina»), `docs/team/SCELTE_ANALITICHE.md`
(spina dorsale e decisioni) e `docs/policy/POLICY_PONTE_19.md` (la proposta unificata). Le figure che le illustrano sono le tre dichiarate: `fig05_forbice`,
