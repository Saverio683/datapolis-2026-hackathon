...
figura <- ggplot(dati, aes(eta_2021, ritenzione_rolling3_pct, colour = nome_territorio)) +
  ...
  labs(
    ...
    subtitle = sommario(paste0(
      ...
      "Nel vicinato la discesa non c'è: fra i 22 e i 25 anni i cinque comuni vicini restano piatti (",
      ...
      ". È l'età in cui il vantaggio educativo dovrebbe convertirsi in lavoro; la misura netta, però, non distingue una partenza da un trasloco a pochi chilometri. ",
