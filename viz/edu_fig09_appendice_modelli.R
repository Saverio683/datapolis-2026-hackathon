...
figura <- (residui | capacita) +
  ...
  plot_annotation(
    title = paste0("Bagheria sta sotto l'atteso in tutte e ", nrow(dati),
                   " le specifiche; sull'occupazione le tre restano senza capacità predittiva"),
    subtitle = sommario(paste0(
      "Quanto Bagheria si discosta dal valore che un modello, addestrato sugli altri ", N_TRAINING,
      " comuni siciliani con Bagheria esclusa, le assegnerebbe: a sinistra il residuo (osservato meno previsto) su due esiti del censimento 2011 e tre specifiche ciascuno, ",
      "a destra la capacità predittiva di ognuno di quei modelli. I due pannelli si leggono insieme, perché il primo dice il segno dello scarto e il secondo dice se quel numero abbia una grandezza citabile.\n",
      "A sinistra tutti e sei i residui sono sfavorevoli e nessun intervallo tocca lo zero.\n",
    ...
    caption = didascalia_2b(
      lettura = paste0(
        "nel pannello di sinistra ogni riga è una specifica e la barra orizzontale è l'intervallo di confidenza bootstrap al 95% del residuo: che nessun intervallo tocchi lo zero significa che lo scarto è nella stessa direzione in tutte le specifiche. ",
        ...
        "La riga verticale allo zero separa i due casi, e la misura è l'R quadro in validazione incrociata a 10 falde: quando è negativo il modello non è «poco preciso», è senza contenuto predittivo. ",
        "Le tre specifiche aggiungono variabili una sull'altra (istruzione, poi mobilità, poi contesto territoriale) e non sono modelli alternativi da mettere in gara: servono a vedere se il segno del residuo sopravvive a specifiche diverse. ",
        "Sono regressioni ecologiche fra comuni e mai causali: il residuo dice che Bagheria si discosta dai comuni con tratti simili, non che un tratto produca l'esito."),
      fonte = paste0(
